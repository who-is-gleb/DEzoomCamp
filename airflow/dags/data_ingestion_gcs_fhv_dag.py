...
with DAG(
    dag_id="data_ingestion_gcs_FHV_dag_v1_1",
    ...
    clean_local_space_task = BashOperator(
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> clean_local_space_task
